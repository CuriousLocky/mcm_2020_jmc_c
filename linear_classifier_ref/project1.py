...
def hinge_loss_full(feature_matrix, labels, theta, theta_0):
    ...
    """
    # Your code here
    z = labels * (theta @ feature_matrix.T + theta_0)
    loss = [ 0 if l >= 1 else 1-l for l in z ]
...
def average_perceptron(feature_matrix, labels, T):
    ...
    theta = theta_total / (n*T)
    theta_0 = theta_0_total / (n*T)
    return (theta, theta_0)
#pragma: coderesponse end
...
def classify(feature_matrix, theta, theta_0):
    ...
    """
    # Your code here
    result =np.array(list(map(lambda x: 1 if x > 0 else -1 ,(theta @ feature_matrix.T + theta_0))))
    return result
#pragma: coderesponse end
...
def classifier_accuracy(
    ...
    labels = classify(val_feature_matrix, theta, theta_0)
    labels2 = classify(train_feature_matrix, theta, theta_0)
    return accuracy(labels2, train_labels), accuracy(labels, val_labels)
#pragma: coderesponse end
